var wpAjaxUrl = 'http://tbdev.dev/wp-admin/admin-ajax.php';var flBuilderUrl = 'http://tbdev.dev/wp-content/plugins/bb-plugin/';var FLBuilderLayoutConfig = {
	...
	$(function() {
				...
				$('.fl-node-57c82a9e1cbc9 .fl-mosaicflow-content, .fl-node-57c82a9e1cbc9 .fl-gallery').magnificPopup({
			...
			'image': {
				...
				$('.fl-node-57c82a9e1cbc9 .fl-gallery-item').wookmark({
			align: 'center',
			autoResize: true,
			container: $('.fl-node-57c82a9e1cbc9 .fl-gallery'),
			offset: 20,
			itemWidth: 150
		});
			});
