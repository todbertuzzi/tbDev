...
<figure class="fl-post-grid-svg-post "  itemscope itemtype="<?php FLPostGridModule::schema_itemtype(); ?>">
	...
	<figcaption class="fl-post-grid-text">
		
		<h2 class="fl-post-grid-title provamoQUaaaa" itemprop="headline">
